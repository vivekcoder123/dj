...
<section>
<style>.col-md-3.padd-top-xxs.single-album {
   max-height: 400px;
}
</style>
...
?>
<a href="occasion.php?name=<?php echo $row['slug']?>" class="col-md-3 padd-top-xxs single-album">
...
<div class="title text-center bg-off padd-top-xxs padd-bottom-xxs">DJ CHIRAG DUBAI - BOLLY MOLLY</div>
</a>
<?php 
  }
}else{
	echo "<h3 class='text-center text-danger' style='font-weight:bold;'>No event is available yet</h3>";
} 
?>
